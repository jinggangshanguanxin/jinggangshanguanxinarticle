// 临时校验：用最小 DOM 桩在 Node 里跑通 reader/app.js 的启动、路由、搜索、主题流程
// 仅本地验证用，不属于项目内容
import fs from 'node:fs';
import path from 'node:path';

const READER = 'D:/dev/front-text/reader';
...
class El {
  ...
  dispatch(type, ev = {}) { (this.listeners[type] || []).forEach((fn) => fn({ target: this, ...ev })); }
